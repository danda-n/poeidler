...
export const MapDevice = memo(function MapDevice({
  ...
  return (
    <div className="flex flex-col items-center gap-2 py-3">
      ...
      <div className="relative w-[200px] h-[120px] rounded-2xl border-2 border-[rgba(244,213,140,0.25)] bg-gradient-to-b from-[rgba(244,213,140,0.08)] to-[rgba(255,255,255,0.02)] flex flex-col items-center justify-center gap-1 shadow-[0_0_30px_rgba(244,213,140,0.06)]">
        <span className="text-[0.64rem] font-extrabold uppercase tracking-[0.1em] text-[#7f8ca3]">Map Device</span>
        <span className="text-[0.82rem] font-bold" style={{ color: getRarityColor(craftedMap.rarity) }}>
          {getRarityLabel(craftedMap.rarity)} {mapDef.name}
        </span>
        <div className="flex items-center gap-2 text-[0.6rem] text-text-secondary">
