...
export function MapToast({ notification }: MapToastProps) {
  ...
  return (
    <div className="map-toast">
      ...
      <div className="map-toast-summary">~{formatCurrencyValue(result.totalRewardValue)} reward value</div>
      <div className="map-toast-rewards">
        ...
        {result.shardDropped && <span className="map-toast-item map-toast-shard-item">+1 Mirror Shard</span>}
      </div>
    </div>
  );
}
